...
pub(super) const HELP_TEXT: &[&str] = &[
    ...
    "",
    "Override management",
    "  m                open/close the override management pane (closes",
    ...
    "  o                edit the highlighted entry — type, origin and",
    "                   display name at once — as a pre-filled",
    "                   \":override-as\" (in the main pane, o edits the",
    "                   cursor node's own override the same way)",
    "  Esc              close the management pane",
    "  :override-as [<FQDN>] [--origin <origin>] [--field-name <name>]",
    "                   record an override: render <origin> as <FQDN>,",
    "                   or as raw/unschema'd when <FQDN> is omitted, and",
    "                   name the field <name> in its parent. <origin> is",
    "                   /path, /path:field or fqdn:field; it defaults to",
    "                   the cursor node's path. Tab completes the FQDN,",
    "                   the origin, and (after a leading -) the options",

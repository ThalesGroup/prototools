...
pub(super) const HELP_TEXT: &[&str] = &[
    ...
    "  Ctrl-Right       next step        (navigation on)",
    "  Ctrl-Left        previous step    (navigation on)",
    "  Ctrl-Down        scroll the script pane down  (navigation on)",
    "  Ctrl-Up          scroll the script pane up    (navigation on)",
